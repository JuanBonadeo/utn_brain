...
> `npm run docx -- materias/ASI/entregables/etapa3-v2.md materias/ASI/entregables/etapa3-v2.docx`
> y después `scripts/preview-docx.ps1`. No editar los generados a mano.
>
> **Qué es esta versión.** Es una copia de trabajo de `etapa3.md`, que queda intacto. Sobre
> ella se incorporó el Anexo II con las cuatro láminas que el documento comprometía como
> adjuntos y que no existían.
>
...
> **Nota.** Ambos planos se adjuntan en el **Anexo II — Documentación gráfica**, archivo
> independiente `etapa3-anexo-graficos.pdf`, por no admitir el presente documento la inclusión
> de imágenes. El plano de la base operativa es la **figura 3** y el croquis tipo de trabajo en
> campo, la **figura 4**. Ambas láminas están confeccionadas en planta, a escala uniforme, con
> el norte indicado y con una simbología común, cuyo detalle acompaña a la figura 3. Las cotas
> que figuran en ellas son las que este apartado declara como mínimos de diseño supuestos.
...
El diagrama en formato gráfico, con los nodos y las flechas de precedencia dibujados, **se adjunta en el Anexo II — Documentación gráfica, figura 1**, por no admitir el presente documento la inclusión de imágenes. Por su extensión —cincuenta y una actividades encadenadas en treinta niveles de precedencia— la lámina se despliega en dos bandas: la banda A cubre las actividades 1.1 a 5.3 y la banda B, las actividades 5.4 a 11.4. Las ocho relaciones de precedencia que cruzan de una banda a la otra se indican con etiquetas de continuidad sobre los nodos de origen y de destino. La tabla que sigue contiene la totalidad de la información del diagrama y permite reconstruirlo íntegramente: las columnas de precedencia definen las flechas, y las columnas de fechas definen el contenido de cada nodo. Los identificadores en **negrita** corresponden a actividades críticas. Las denominaciones completas de cada paquete se encuentran en la tabla de la EDT del punto 4.3.
...
El diagrama de Gantt en formato gráfico —barras horizontales por actividad sobre el eje de tiempo, con el camino crítico destacado, las holguras representadas en trazo discontinuo y los hitos de control señalados— **se adjunta en el Anexo II — Documentación gráfica, figura 2.a**, por no admitir el presente documento la inclusión de imágenes. El **histograma de recursos por perfil** ocupa la lámina siguiente, **figura 2.b**, trazado sobre el mismo eje de tiempo y a la misma escala, de modo que ambas hojas se leen superpuestas: para cada día hábil del cronograma puede contrastarse qué actividades están en curso y qué dotación de cada perfil requieren. La línea de puntos de cada perfil marca la dotación asignada, que no se supera en ningún día.

Las barras se dibujan sobre las fechas del cronograma aplanado adoptado. La holgura que se representa en trazo discontinuo es la **holgura remanente**: la holgura total del cálculo de camino crítico menos el corrimiento que el aplanamiento aplicó a esa actividad. Las treinta actividades críticas se representan, en consecuencia, sin holgura; y los paquetes 5.6, 7.5 y 6.2 aparecen con holgura nula porque el aplanamiento consumió íntegramente la suya, que es el origen de los cinco días de desvío descriptos más arriba.
...
|---|---|---|---|
| Figura 1 | Diagrama de Red en notación de actividad en el nodo. Las 51 actividades de la EDT con sus predecesoras, duración, fechas tempranas y tardías y holgura total, con el camino crítico destacado. Se despliega en dos bandas, con etiquetas de continuidad para las ocho precedencias que cruzan de una a la otra | 10 · Diagrama de Red | Sin escala |
