...
- **"¿Por qué dos personas en integraciones y en pruebas?" / "¿De dónde salen los 23 días?"** → El atraso no lo causa el trabajo, lo causa que **la misma persona esté pedida en dos lugares a la vez**. El cronograma teórico pone las cuatro integraciones —SGOT, CRM, base de clientes y NMS— en la misma ventana, pero hay **un solo** especialista: van una atrás de otra, **en fila india**. Y como están sobre el camino crítico, cada día de espera se traslada entero al final. Con eso el proyecto se va a **215**. Con un segundo especialista y un segundo de pruebas la fila desaparece y queda en **192**. **215 − 192 = 23.**
  - Para decir: *"Con una sola persona en integraciones, las cuatro se hacen una atrás de otra en vez de en paralelo, y como están en el camino crítico esa espera se traslada entera al final. El segundo especialista rompe esa fila: son 23 días."*
  - Remate de una línea: *"No es que trabajen más rápido: es que dejan de hacer cola."*
  - **Trampa:** *"¿y no podían correrlas dentro de la holgura?"* → **No.** Los seis conflictos caen sobre **actividades críticas**, y crítico significa holgura cero. No hay adónde correrlas: o más gente, o el proyecto se estira.
